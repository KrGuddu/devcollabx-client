    ...
    return (
      <div className="join-container">
        <div className="app-header">
          ...
          {/* <h1 className="app-title">DevCollabX</h1> */}
          <h1 className="app-title">
            Dev<span style={{ color: "#6366F1" }}>Collab</span>X
          </h1>
          <p className="app-description">Code Together. Build Faster.</p>
    ...
    <div className="editor-container">
      <div className="sidebar" role="complementary" aria-label="Room sidebar">
        <div className="sidebar-header">
          <h2 className="sidebar-title">DevCollabX</h2>
          <div
